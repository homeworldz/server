...
// Tell a viewer to drop its connection to this simulator now, rather than
// discovering its death by ping timeout (ADR 0036: sent for the old facet
// when an internal crossing re-tags the circuit).
